function [ sum_obj, simulation_result_linear, experiment_result_linear ] = calculate_obj_fakeTraits( trait, basal_level, induction_level )
...
simulation_result_linear = simulation_result;
