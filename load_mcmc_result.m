...
%             elseif strcmp(mcmc_version, 'Simulated_Annealing')
            elseif strcmp(mcmc_version, 'AlsoFitGAL34')
                mcmc_result = [ ...
                    mcmc_result; ...
                    table( ...
                    {filepath}, max_iter, param_map, param_prob_map, {jobtag}, {prob_data_over_parameter_list}, average_accept, {GAL1_trait}, ...
                    'VariableNames', {'filepath', 'max_iter', 'param_map', 'param_prob_map', 'jobtag', 'param_prob_list', 'average_accept', 'trait'} ...
                    )...
                    ];
