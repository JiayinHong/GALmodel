        ...
        if ismember(tok{1}, jobtags)
            ...
            if strcmp(mcmc_version, '3.0')
                mcmc_result = [ ...
                    mcmc_result; ...
                    table( ...
                    {filepath}, max_iter, param_map, param_prob_map, {jobtag}, {sum_posterior_prob_list}, average_accept, {trait}, ...
                    'VariableNames', {'filepath', 'max_iter', 'param_map', 'param_prob_map', 'jobtag', 'sum_posterior_prob_list', 'average_accept', 'trait'} ...
                    ) ...
                    ];
            ...
            elseif regexp(mcmc_version, '\w*prior_included$')
                ...
                mcmc_result = [ ...
                    mcmc_result; ...
                    table( ...
                    {filepath}, max_iter, param_map, param_prob_map, map_data_over_param, map_param_over_prior, {jobtag}, {param_prob_list}, average_accept, {GAL1_trait}, ...
                    'VariableNames', {'filepath', 'max_iter', 'param_map', 'param_prob_map', 'map_data_over_param', 'map_param_over_prior', 'jobtag', 'param_prob_list', 'average_accept', 'trait'} ...
                    )...
                    ];
