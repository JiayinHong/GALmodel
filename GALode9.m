function dydt = GALode9( t, y, param )
...
% 2017.11.15 GAL model v9.0
% to verify the model can't capture the ratio metric without competitive
% binding through GAL2 transporter
...
dgal = (kbase + kgal*G2) * exgal/(exgal + KMgal) - G3star_f + G3star_r - dsugar * gal;
