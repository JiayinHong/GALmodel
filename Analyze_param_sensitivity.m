...
export_fig(fullfile('../results/param_sensitivity_analysis2/', sprintf('obj_one_col, vary by %.2f', percent_to_change)));
...
export_fig(fullfile('../results/param_sensitivity_analysis2/', sprintf('obj_one_row, vary by %.2f', percent_to_change)));
...
export_fig(fullfile('../results/param_sensitivity_analysis2/', sprintf('obj_one_cross, vary by %.2f', percent_to_change)));
